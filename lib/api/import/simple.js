...
function configure(app, wares, ctx, env) {
  ...
  api.post('/simple', async function(req, res) {
    ...
    try {
      ...
      // Since this runs before tenant resolver, we need to use the hardcoded URI
      const targetUri = 'mongodb+srv://multi-ns:DiabeetechMulti2024@nightscout-multitenant.3o14b.mongodb.net/nightscout-master?retryWrites=true&w=majority&appName=nightscout-multitenant';
      if (!targetUri) {
