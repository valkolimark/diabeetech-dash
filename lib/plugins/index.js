...
function init (ctx) {
  ...
  plugins.register = function register (all) {
    console.log('plugins.register called with', all.length, 'plugins');
    ...
    console.log('plugins.register - ctx.settings.enable:', enable);
    ...
    console.log('plugins.register - Total enabled plugins:', enabledPlugins.length);
  };
  ...
  plugins.setProperties = function setProperties (sbx) {
    console.log('setProperties called, enabledPlugins length:', enabledPlugins.length);
    console.log('setProperties called, enabled plugins:', enabledPlugins.map(p => p.name));
    console.log('sbx.withExtendedSettings exists:', typeof sbx.withExtendedSettings);
    console.log('allPlugins length:', allPlugins.length);
    console.log('ctx.settings.enable:', ctx.settings && ctx.settings.enable);
    
    plugins.eachEnabledPlugin(function eachPlugin (plugin) {
      if (plugin.setProperties) {
        try {
          console.log('Calling setProperties for plugin:', plugin.name);
    ...
    console.log('After setProperties, sbx.properties:', Object.keys(sbx.properties || {}));
  };
