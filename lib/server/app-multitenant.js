...
function create (env, ctx) {
  ...
  app.use((req, res, next) => {
    ...
    const publicPaths = ['/api/v1/status', '/api/v1/echo', '/manifest.json', '/sw.js', '/login', '/api/auth'];
  ...
  // Simple import API (temporary)
  app.use('/api/simple-import', bodyParser.json({ limit: 1048576 * 50 }), createTenantAwareApiMiddleware(require('../api/import/simple')));
