...
function create (env, ctx) {
  ...
  // Admin static files (serve before the main route)
  app.use('/admin', express.static(path.join(__dirname, '../../static/admin'), { maxAge }));
  
  // Admin dashboard route (superadmin only, bypasses tenant requirements)
  ...
  // Admin API routes (superadmin only, bypasses tenant requirements)
