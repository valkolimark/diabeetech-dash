...
function boot (env, language) {
  ...
  function checkSettings (ctx, next) {
    ...
    if (env.settings.authDefaultRoles == 'readable') {
      const message = {
        title: "Diabeetech readable by world"
        ,message: "Your Diabeetech installation is readable by anyone who knows the web page URL. Please consider closing access to the site by following the instructions in the <a href=\"http://nightscout.github.io/nightscout/security/#how-to-turn-off-unauthorized-access\" target=\"_new\">Diabeetech documentation</a>."
        ,persistent: true
      };
